...
class _AppContentState extends State<AppContent> with TickerProviderStateMixin {
  ...
  final List<TabItem> tabs = [
    TabItem(id: 'home', icon: Icons.home, label: 'Beranda', gradient: [Color(0xFF3B82F6), Color(0xFF8B5CF6)]),
    TabItem(id: 'search', icon: Icons.search, label: 'Cari', gradient: [Color(0xFF10B981), Color(0xFF3B82F6)]),
    TabItem(id: 'ai', icon: Icons.auto_awesome, label: 'AI', gradient: [Color(0xFF8B5CF6), Color(0xFFEC4899)]),
    TabItem(id: 'favorites', icon: Icons.favorite, label: 'Favorit', gradient: [Color(0xFFEC4899), Color(0xFFEF4444)]),
    TabItem(id: 'profile', icon: Icons.person, label: 'Profil', gradient: [Color(0xFF6366F1), Color(0xFF8B5CF6)]),
  ];
  ...
  String _getHeaderText() {
    switch (_activeTab) {
      case 0:
        return '🍳 Temukan resep dari bahan yang ada';
      case 1:
        return '🔍 Cari resep berdasarkan bahan';
      case 2:
        return '✨ AI Smart Assistant';
      case 3:
        return '❤️ Resep favorit Anda';
      case 4:
